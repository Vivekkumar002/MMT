...
public class LocatorProvider {
	...
	/**
	 * LocatorsFilePathSetter(): It sets the filePath of the locators data file by
	 * passing fileName in the parameter.
	 */
	public static void LocatorsFilePathSetter(String fileName) {
		LocatorsFilePath = "src/main/resources/Locators/" + fileName + ".txt";
	}

	/**
	 * LocatorProvider(): It provides the locatorType and locatorValue of the
	 * WebElement and then call getLocatorValue() to get the locator.
	 */
