...
public class BaseClass {
	...
	public RemoteWebDriver web_driver;
	...
	public void mmtWebApp() throws Exception {
		DesiredCapabilities dec = new DesiredCapabilities();
		dec.setCapability("deviceName", "Mi A1");
		dec.setCapability("platformVersion", "9.0");
		dec.setCapability("platformName", "Android");
		dec.setCapability("udid", "6f699b080504");
		dec.setCapability(CapabilityType.BROWSER_NAME, "Chrome");
		dec.setCapability("chromedriverExecutable", "C:\\Users\\FLOPPY\\Automation\\vivekqa\\Driver\\chromedriver.exe");

		web_driver = new RemoteWebDriver(new URL("http://127.0.0.1:4723/wd/hub"), dec);
		web_driver.get("https://www.makemytrip.com/");
